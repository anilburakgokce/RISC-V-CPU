...
\TLV
   ...
   $imm_valid = $is_s_instr || $is_i_instr || $is_u_instr || $is_j_instr || $is_b_instr;
   $imm[31:0] = $is_i_instr ? { {21{$instr[31]}},  $instr[30:20]  } :
                $is_s_instr ? { {20{$instr[31]}}, $instr[31:25], $instr[11:7] } :
                $is_u_instr ? { {12{$instr[31]}}, $instr[31:12] } :
                $is_b_instr ? { {20{$instr[31]}}, $instr[7], $instr[30:25], $instr[11:8], 1'b0 }:
                $is_j_instr ? { {13{$instr[31]}}, $instr[19:12], $instr[30:21], 1'b0} :
                32'b0;  // Default 
   ...
   $is_load = ($dec_bits ==? 11'bx_0xx_0000011) || ($dec_bits ==? 11'bx_10x_0000011); 
